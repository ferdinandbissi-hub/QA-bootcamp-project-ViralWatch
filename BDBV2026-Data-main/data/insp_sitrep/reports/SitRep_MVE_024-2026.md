...
Copy this file for each sitrep (e.g. `SitRep_MVE_015-2026.md`) and record any non-routine decisions taken while digitising.

| Field | Value |
| --- | --- |
| **Sitrep number** | 24 |
| **Digitiser** | Patrick and Bernardo |
| **Report date** | 7 June 2026 |
| **Digitising date** | 8 June 2026 |
...
**Decisions / notes:** Transcribed straight from banner
...
**Decisions / notes:** no data reported
...
**Decisions / notes:** Transcribed directly from Table 1.
...
**Decisions / notes:** not reported at health zone level
...
**Decisions / notes:** not reported at health zone level today
